...
public:
	...
	DFA(vector<int>& tCharMap, AstNode* tAstRoot, int Index, vector<AstNode*>& tAstNodeList, int tCharEndIndex) :CharMap(tCharMap),  AstRootIndex(Index), AstNodeList(tAstNodeList), CharEndIndex(tCharEndIndex)
	{
...
void AstNode::Accept(AutoMachine& Dfa, int CurrentIndex)
{
	abort();
}
void Repeat::Accept(AutoMachine& Dfa, int CurrentIndex)
{
	Dfa.VisitSpecNode(this, CurrentIndex);
}
void Nullable::Accept(AutoMachine& Dfa, int CurrentIndex)
{
	Dfa.VisitSpecNode(this, CurrentIndex);
}
void CharSet::Accept(AutoMachine& Dfa, int CurrentIndex)
{
	Dfa.VisitSpecNode(this, CurrentIndex);
}
void Link::Accept(AutoMachine& Dfa, int CurrentIndex)
{
	Dfa.VisitSpecNode(this, CurrentIndex);
}
void NormalChar::Accept(AutoMachine& Dfa, int CurrentIndex)
{
	Dfa.VisitSpecNode(this, CurrentIndex);
}
void ChoseSymbol::Accept(AutoMachine& Dfa, int CurrentIndex)
{
	Dfa.VisitSpecNode(this, CurrentIndex);
}
void StringTail::Accept(AutoMachine& Dfa, int CurrentIndex)
{
	Dfa.VisitSpecNode(this, CurrentIndex);
}
//
...
//public:
//	NFA(vector<int>& tCharMap, int Index, vector<AstNode*>& tAstNodeList) :CharMap(tCharMap),AstRootIndex(Index), AstNodeList(tAstNodeList)
//	{
//	//	initNFAStuats();
//	}
//	NFA() = delete;
